...
export const FIELD_REGISTRY = {
  ...
  "investments.properties[].value_estimate": { label: "what the property is worth", retrieval: "required", evidence: ["lender_valuation", "rates_notice", "portal_estimate", "appraisal"], paths: ["home_value"], accepts_upload: true, confidence_floor: "stated", range_permitted: true, softeners: "forbidden", feeds: ["property_equity"] },
